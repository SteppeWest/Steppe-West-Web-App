...
class Contact extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['profile_user_id', 'country_code', 'email', 'phone', 'telegram', 'created_at', 'updated_at'], 'default', 'value' => null],
            [['sort_order'], 'default', 'value' => 0],
            [['is_active'], 'default', 'value' => 1],
            [['profile_user_id', 'has_whatsapp', 'has_signal', 'has_viber', 'is_staff', 'is_public', 'is_active', 'sort_order', 'created_at', 'updated_at'], 'integer'],
            [['country_code'], 'string', 'max' => 8],
            [['email'], 'string', 'max' => 255],
            [['phone', 'telegram'], 'string', 'max' => 32],
        ];
    }
