...
/**
 * SWCurrentLanguageSearch represents the model behind the search form of `letter\models\SWCurrentLanguage`.
 */
class SWCurrentLanguageSearch extends SWCurrentLanguage
{
	...
	public function rules()
	{
		return [
			[['pk'], 'integer'],
			[['code', 'page', 'title', 'subtitle', 'description', 'keywords', 'lead', 'origin', 'origin_link', 'body_yaml'], 'safe'],
		];
	}
